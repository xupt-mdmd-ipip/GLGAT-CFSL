...
for iDataSet in range(nDataSet):
    ...
    CSA_block_att = CSA_block.AttentionalGNN(num_supports, 320, ['self'] *9,checkpointed=False,
                 skip=False, inter_supervision=None, num_line_iterations=1,
                 line_attention=False).to(GPU)#修改:self*9还是self*1,gluestick原代码中是self*9，在代码最上方
    ...
    for episode in range(EPISODE):
        ...
        print('support_labels_src',support_labels_src.size())
        print('support_labels_src', support_labels_src)
        ...
        cross_att_loss = CSA_block_att(point_nodes_src, point_nodes_tar,distribution_nodes_src,distribution_nodes_tar, point_edge_src, point_edge_tar)#修改
